          ...
          <main className="container-full-width next-classic-page-content">
            <main className="b2c-shell">
              {table ? (
                ...
                <section className="b2c-form-workspace next-b2c-loading-forms-classic">
                  <div className="b2c-form-workspace__intro"><div><span className="next-b2c-loading-line-wide" /></div><div className="b2c-top-actions"><span className="next-b2c-loading-button" /><span className="next-b2c-loading-button next-b2c-loading-button-primary" /></div></div>
                  <div className="next-b2c-loading-forms-toolbar" />
                  <section className="b2c-forms-library">{Array.from({ length: 6 }).map((_, index) => <article className="b2c-form-card next-b2c-loading-form-card" key={index}><div className="b2c-form-card__head"><span className="b2c-form-card__icon" /><span className="next-b2c-loading-pill" /></div><span className="next-b2c-loading-form-title" /><span className="next-b2c-loading-form-copy" /><div className="b2c-form-card__footer"><span className="next-b2c-loading-form-count" /><span className="next-b2c-loading-form-action" /></div></article>)}</section>
                </section>
              ) : (
