...
export default function LmsCurriculumClient({ initialCatalog, access, initialThemeId = "", initialGradeId = "", bootstrapWarnings = [] }) {
  ...
  return (
    <main className="next-lms-curriculum-page">
      ...
      {bootstrapWarnings.length ? <div className="dashboard-notice" role="status"><strong>Some Curriculum support data could not load.</strong><span>The available folders are shown below. Use Refresh to retry the missing data.</span></div> : null}
