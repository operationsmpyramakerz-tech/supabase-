...
export default function LmsSchoolWorkspaceClient({ schoolId, initialSchool, initialStock, access, bootstrapWarnings = [] }) {
  ...
  return (
    <main className="next-lms-school-page">
      ...
      {bootstrapWarnings.length ? <div className="dashboard-notice" role="status"><strong>Some school data could not be included in the first load.</strong><span>The available data is shown below; use Refresh to retry.</span></div> : null}
