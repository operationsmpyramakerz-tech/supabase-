export default function ClassicOrderIcon({ name, className = "" }) {
  const common = {
    viewBox: "0 0 24 24",
    fill: "none",
    stroke: "currentColor",
  ...
  const paths = {
    ...
    "edit-2": <><path d="M17 3a2.121 2.121 0 0 1 3 3L7.5 18.5 3 20l1.5-4.5L17 3z"/></>,
    "rotate-ccw": <><polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 1 0 .49-9.36L1 10"/></>,
