...
export default async function EventComponentsPage({ searchParams }) {
  ...
  return (
    <AppShell account={account} title="Events" eyebrow="Reusable event resources" activePath="/next/event-components" bodyClass="events-page events-components-page" classicStyles={["/css/events.css?v=next-stage-2k-events"]}>
