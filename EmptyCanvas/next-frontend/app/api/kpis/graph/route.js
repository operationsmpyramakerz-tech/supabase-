...
import { directKpisContext, kpiErrorMessage, kpisGraph } from "../../../../lib/kpis-data";
...
export async function GET(request) {
  ...
  try {
    ...
    return NextResponse.json(await kpisGraph(context, params, { force: fresh }), { headers: { "Cache-Control": "no-store" } });
  } catch (error) {
