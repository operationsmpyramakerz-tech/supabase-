...
import { directKpisContext, kpiErrorMessage, kpisReviewDetail } from "../../../../../lib/kpis-data";
...
export async function GET(request, { params }) {
  ...
  try {
    ...
    return NextResponse.json(await kpisReviewDetail(context, resolved?.id, { force: fresh }), { headers: { "Cache-Control": "no-store" } });
  } catch (error) {
