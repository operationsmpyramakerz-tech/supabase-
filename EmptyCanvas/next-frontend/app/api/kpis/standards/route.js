...
import { directKpisContext, kpiErrorMessage, kpisStandards } from "../../../../lib/kpis-data";
...
export async function GET(request) {
  ...
  try {
    ...
    return NextResponse.json(await kpisStandards(context, params, { force: fresh }), { headers: { "Cache-Control": "no-store" } });
  } catch (error) {
