...
import { b2cErrorMessage, b2cFormsPayload, directB2cContext } from "../../../../lib/b2c-data";
...
export async function GET(request) {
  ...
  try {
    ...
    return NextResponse.json(await b2cFormsPayload({ force }), { headers: { "Cache-Control": "no-store" } });
  } catch (error) {
