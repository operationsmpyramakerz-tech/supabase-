...
const steps = [
  ...
  ["Visual parity with Classic", "In progress", "Stage 2 now covers the Classic Login, authenticated global shell (sidebar/header/notifications), Home dashboard, Current Orders, Orders Review, Operations Orders, Maintenance Orders, Shopping Cart/Create Order, Products, and Stocktaking. Products now reuses the Classic tag filter, grouped compact product cards, product/tag action menus, product editor, unit/tag selectors, and image flow; Stocktaking now reuses the Classic grouped inventory cards, header search, Download action, export modal, and route loading states. Remaining modules will be matched page by page."],
  ["Responsive parity", "In progress", "The Stage 2 shell, Login/Home, Current Orders, Orders Review, Operations Orders, Maintenance Orders, Shopping Cart/Create Order, Products, and Stocktaking now reuse the Classic responsive layout rules. Tablet/mobile behavior still requires page-by-page visual QA before approval."],
