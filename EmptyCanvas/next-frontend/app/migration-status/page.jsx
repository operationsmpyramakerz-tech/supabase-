...
const steps = [
  ...
  ["Visual parity with Classic", "In progress", "Stage 2 now covers the Classic Login, authenticated global shell (sidebar/header/notifications), Home dashboard, Current Orders, Orders Review, Operations Orders, Maintenance Orders, and Shopping Cart/Create Order, including their toolbars, filters, cards, status presentation, workflow/detail modals, protected actions, draft/edit flows, and route loading states. Remaining modules will be matched page by page."],
  ["Responsive parity", "In progress", "The Stage 2 shell, Login/Home, Current Orders, Orders Review, Operations Orders, Maintenance Orders, and Shopping Cart/Create Order reuse the Classic responsive layout rules. Tablet/mobile behavior still requires page-by-page visual QA before approval."],
