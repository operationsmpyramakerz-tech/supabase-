...
const steps = [
  ...
  ["Visual parity with Classic", "In progress", "Stage 2 now covers the Classic Login, authenticated global shell (sidebar/header/notifications), Home dashboard, Current Orders, Orders Review, Operations Orders, Maintenance Orders, Shopping Cart/Create Order, Products, Stocktaking, Expenses, Expenses Users, Proposals, Kits, B2C Database, B2C Table Workspace, B2C Forms, Task Management, Event Requests, New/Edit Event Request, Event Components, Event Calendar, KPIs, and Users Center. Stage 2M reuses the original Users Center stylesheet and restores department folders, member cards, sign-up approvals, member editing, move/delete actions, page-access matrices, Orders Review visibility, admin verification, loading states, global-header search, and responsive behavior while preserving the existing Next.js Users Center workflows and APIs."],
  ["Responsive parity", "In progress", "The Stage 2 shell, Login/Home, Current Orders, Orders Review, Operations Orders, Maintenance Orders, Shopping Cart/Create Order, Products, Stocktaking, Expenses, Expenses Users, Proposals, Kits, B2C Database, B2C Table Workspace, B2C Forms, Task Management, the complete Events workspace, KPIs, and Users Center now reuse the Classic responsive layout rules. Tablet/mobile behavior still requires page-by-page visual QA before approval."],
