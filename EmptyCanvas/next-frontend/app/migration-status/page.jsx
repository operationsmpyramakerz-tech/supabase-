...
const steps = [
  ...
  ["Legacy URL cutover", "Code ready", "Legacy ERP URLs now prefer their migrated Next.js workspaces while preserving query parameters, dynamic deep links, and permission checks."],
  ...
  ["Classic rollback removal", "Code ready", "User-facing Classic rollback links have been removed from the migrated frontend. Emergency rollback is now deployment-controlled rather than exposed through browser URLs."],
  ...
  ["New-interface cleanup", "In progress", "The migrated Next.js interface is now the only user-facing frontend. Legacy page files remain temporarily only while shared CSS, scripts, and assets are moved into the Next.js application."],
];
