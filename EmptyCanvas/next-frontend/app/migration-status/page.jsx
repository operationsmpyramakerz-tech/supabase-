...
const steps = [
  ...
  ["App Install & PWA", "Completed", "The installed-app launcher, PWA diagnostics, browser installation flow, native download links, service-worker refresh controls, offline fallback behavior, and Next.js app shortcuts now use the migrated frontend."],
