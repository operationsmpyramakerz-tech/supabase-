...
const steps = [
  ...
  ["Visual parity with Classic", "In progress", "Stage 2 now covers the Classic Login, authenticated global shell (sidebar/header/notifications), Home dashboard, Current Orders, Orders Review, Operations Orders, Maintenance Orders, Shopping Cart/Create Order, Products, Stocktaking, Expenses, Expenses Users, Proposals, Kits, B2C Database, and the B2C Table Workspace. Stage 2H restores the Classic B2C folder library, compact table folders and 3-dot menus, the dedicated data-table canvas, Classic insights/table styling, record actions, property/configuration dialogs, formula tooling, Excel access, global-header search, and the original responsive B2C page rules. B2C Forms remains the next B2C visual-parity stage."],
  ["Responsive parity", "In progress", "The Stage 2 shell, Login/Home, Current Orders, Orders Review, Operations Orders, Maintenance Orders, Shopping Cart/Create Order, Products, Stocktaking, Expenses, Expenses Users, Proposals, Kits, B2C Database, and B2C Table Workspace now reuse the Classic responsive layout rules. Tablet/mobile behavior still requires page-by-page visual QA before approval."],
