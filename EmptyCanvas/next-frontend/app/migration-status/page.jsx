...
const steps = [
  ...
  ["Visual parity with Classic", "In progress", "Stage 2 now covers the Classic Login, authenticated global shell (sidebar/header/notifications), Home dashboard, Current Orders, Orders Review, Operations Orders, Maintenance Orders, Shopping Cart/Create Order, Products, Stocktaking, Expenses, Expenses Users, Proposals, Kits, B2C Database, B2C Table Workspace, and B2C Forms. Stage 2I restores the Classic B2C Forms workspace, form cards, linked-form entry canvas, dynamic field styling, success/error states, direct file-upload presentation, create/edit dialogs, required controls, conditional visibility controls, drag-and-drop Form Builder, global-header search, and the original responsive B2C form rules."],
  ["Responsive parity", "In progress", "The Stage 2 shell, Login/Home, Current Orders, Orders Review, Operations Orders, Maintenance Orders, Shopping Cart/Create Order, Products, Stocktaking, Expenses, Expenses Users, Proposals, Kits, B2C Database, B2C Table Workspace, and B2C Forms now reuse the Classic responsive layout rules. Tablet/mobile behavior still requires page-by-page visual QA before approval."],
