...
const steps = [
  ...
  ["Visual parity with Classic", "In progress", "Stage 2 now covers the Classic Login, authenticated global shell (sidebar/header/notifications), Home dashboard, Current Orders, Orders Review, Operations Orders, Maintenance Orders, Shopping Cart/Create Order, Products, Stocktaking, Expenses, Expenses Users, Proposals, Kits, B2C Database, B2C Table Workspace, B2C Forms, Task Management, Event Requests, New/Edit Event Request, Event Components, and Event Calendar. Stage 2K reuses the original Events stylesheet and restores the Classic request cards, status toolbar, event form sections, component catalogue cards, monthly calendar, event dialogs, loading states, and responsive behavior while preserving the existing Next.js workflows and APIs."],
  ["Responsive parity", "In progress", "The Stage 2 shell, Login/Home, Current Orders, Orders Review, Operations Orders, Maintenance Orders, Shopping Cart/Create Order, Products, Stocktaking, Expenses, Expenses Users, Proposals, Kits, B2C Database, B2C Table Workspace, B2C Forms, Task Management, and the complete Events workspace now reuse the Classic responsive layout rules. Tablet/mobile behavior still requires page-by-page visual QA before approval."],
