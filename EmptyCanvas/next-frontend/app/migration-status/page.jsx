...
const steps = [
  ...
  ["Visual parity with Classic", "In progress", "Stage 2 now covers the Classic Login, authenticated global shell (sidebar/header/notifications), Home dashboard, Current Orders, Orders Review, Operations Orders, Maintenance Orders, Shopping Cart/Create Order, Products, Stocktaking, Expenses, and Expenses Users. Expenses now reuses the Classic cash-flow summary, monthly/type analytics, Cash in/out actions, grouped ledger and ticket views, settlement flow, receipt viewer, and export controls; Expenses Users now reuses the Classic balance cards, iOS-style expense sheet, settlement split, date/sort controls, grouped tickets, receipt viewer, protected edit/delete actions, and per-user exports. Remaining modules will be matched page by page."],
  ["Responsive parity", "In progress", "The Stage 2 shell, Login/Home, Current Orders, Orders Review, Operations Orders, Maintenance Orders, Shopping Cart/Create Order, Products, Stocktaking, Expenses, and Expenses Users now reuse the Classic responsive layout rules. Tablet/mobile behavior still requires page-by-page visual QA before approval."],
