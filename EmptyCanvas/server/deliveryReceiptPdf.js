...
async function pipeDeliveryReceiptPDF(
  ...
  const allColumnDefs = [
    ...
    { key: "receivedQty", label: "Received Qty", ratio: 0.11, align: "right" },
    { key: "remainingQty", label: "Remaining Qty", ratio: 0.11, align: "right" },
    { key: "deliveredQty", label: "Delivered Qty", ratio: 0.11, align: "right" },
  ...
  function drawItemRow(r, visualIndex = 0, repeatHeader = null) {
    ...
    const rowData = {
      ...
      receivedQty: String(Number(r.receivedQty) || 0),
      remainingQty: String(Number(r.remainingQty) || 0),
      deliveredQty: String(Number(r.deliveredQty) || 0),
